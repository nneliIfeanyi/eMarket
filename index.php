		...
		<!-- Commerce SECTION -->
			...
			<div id="msg" class="">
				...
				<div class="w3-half w3-padding-large">
					<img src="admin/<?=$img?>" class="w3-image w3-circle" height="200px" width="80%">
				</div>
				...
				<div class="w3-half w3-padding-16">
					<ul class="w3-ul">
						...
						<li class="w3-margin-top">
							...
							<a href="buy_now.php?product_id=<?=$id?>" class="w3-btn w3-text-light-grey w3-teal w3-large w3-round-large">Buy now</a>
						

							<a href="add_to_cart.php?product_id=<?=$id?>" class="w3-btn w3-text-light-grey w3-teal w3-large w3-round-large">Add to cart</a>
		...
		<!-- SELECTING CUPS CATEGORIES -->
			 ...
			 <div id="showCUPS" class=""  style="display: none;">
			   ...
			   <div class="">
			    		...
			    		$sql = "SELECT * FROM products WHERE category ='cats' ";
			    		$query = mysqli_query($conn, $sql);
			    		if (mysqli_num_rows($query) > 0) {
