...
include 'functions.php';
	...
	if (!$id) {
		...
		if ($_SERVER['REQUEST_METHOD'] == "POST" ) {
			...
			<meta http-equiv="refresh" content=".01; checkout.php?amt=<?=$quantity?>&id=<?=$id?>&title=<?=$title?>&describe=<?=$description?>&price=<?=$price?>&img=<?=$img?>">
...
<body class="w3-serif">
	...
	?>
	<div class="box w3-card-4 w3-padding-16 w3-margin-top">
